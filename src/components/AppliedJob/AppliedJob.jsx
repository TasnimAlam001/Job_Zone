...
const AppliedJob = ({ job }) => {
    const { logo, jobTitle, company, location, salary, jobType1, jobType2 } = job;
    console.log(job)
    return (
        <div className='border border-slate-200 my-5 w-3/4 mx-auto rounded-lg p-5 grid grid-cols-3 gap-4'>
            ...
            <div className='content-center my-auto'>
                <button className='bg-blue-400 hover:bg-blue-600 text-center h-fit  ml-24 p-2 rounded-lg text-white font-semibold'>View Details</button>
            </div>
        </div>
    );
};
